...
class MemberTownQueryServiceImplTest {
    ...
    void getMemberTownListTest() {
        ...
        assertThat(response.getTowns().get(0).getName()).isEqualTo(mockResponse.getTowns().get(0).getName());
        ...
        assertThat(response.getTowns().get(1).getName()).isEqualTo(mockResponse.getTowns().get(1).getName());
        ...
        assertThat(response.getTowns().get(2).getName()).isEqualTo(mockResponse.getTowns().get(2).getName());
