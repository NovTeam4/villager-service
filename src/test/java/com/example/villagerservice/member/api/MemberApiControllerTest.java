...
class MemberApiControllerTest {
    ...
    void updateMemberInfoNotFoundMemberTest() throws Exception {
        ...
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(Member.builder()
    ...
    void updateMemberInfoTest() throws Exception {
        ...
        assertThat(findMember.getNickname()).isEqualTo("닉네임 변경!");
    }
